<?php
//view_inbox.php [Display the message inbox of the respective user with pagination.]
//View_inbox_controller

class View_inbox_controller {
...
$total_records = $mailbox->get_number_of_inbox_messages_by_user();
...
$rows = $mailbox->get_all_inbox_messages_by_user();
if ($rows === false) {
$message = new SystemMessage('There are currently no messages in your inbox.', 'msg_wrapper_mb');
echo $message->render_message();
} else {
include 'templates/frontend_templates/view_inbox_template.php';
}
} catch (Exception $e) {
